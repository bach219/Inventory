...
<template>
 ...
 <div class="row">
  <router-link to="/order" class="btn btn-primary">Hóa đơn hôm nay </router-link>
    ...
    <div class="row justify-content-center">
              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">TÌM KIẾM</h1>
                  </div>
      ...
      <form class="user" @submit.prevent="searchDate">
        ...
        <div class="form-group">
          ...
          <div class="form-row">
            <div class="col-md-12">
        <label for="exampleFormControlTextarea1"><b>Tìm kiếm theo ngày </b></label>
