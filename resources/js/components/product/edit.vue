...
<template>
 ...
 <div class="row">
  <router-link to="/product" class="btn btn-primary">Xem món </router-link>
    ...
    <div class="row justify-content-center">
              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4"> Chỉnh sửa thông tin món</h1>
                  </div>
      ...
      <form class="user" @submit.prevent="ProductUpdate" enctype="multipart/form-data">
        ...
        <div class="form-group">
         ...
         <input type="text" class="form-control" id="exampleInputFirstName" placeholder="" v-model="form.product_name">
       <small class="text-danger" v-if="errors.product_name"> {{ errors.product_name[0] }} </small>
            </div>


     <div class="col-md-6">
      <label for="exampleFormControlSelect1">Mã món</label>
         <input type="text" class="form-control" id="exampleInputFirstName" placeholder="" v-model="form.product_code">
         ...
         <div class="form-group">
          ...
          <div class="form-row">
            <div class="col-md-6">
      <label for="exampleFormControlSelect1">Nhóm món</label>
 ...
 <div class="form-group">
          ...
          <div class="form-row">
            <div class="col-md-4">
              <label for="exampleFormControlSelect1">Giá gốc</label>
 ...
 <div class="col-md-4">
              <label for="exampleFormControlSelect1">Giá mua vào</label>
     ...
     <div class="col-md-4">
      <label for="exampleFormControlSelect1">Giá bán</label>
        ...
        <div class="form-group">
          ...
          <div class="form-row">
            <div class="col-md-6">
              <label for="exampleFormControlSelect1">Ngày mua</label>
  ...
  <small class="text-danger" v-if="errors.buying_date"> {{ errors.buying_date[0] }} </small>
     ...
     <div class="col-md-6">
      <label for="exampleFormControlSelect1">Số lượng</label>
         <input type="text" class="form-control" id="exampleInputFirstName" placeholder="" v-model="form.product_quantity">
