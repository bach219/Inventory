          ...
          <div class="card mb-4">
            ...
            >
              ...
              <router-link to="/store-customer" class="btn btn-sm btn-info"
                ><font color="#ffffff">Thêm khách hàng</font></router-link
              >
            </div>
            ...
            <div class="card-footer">
              <ul class="list-group">
                ...
                >
                  Tổng hóa đơn :
                  <strong v-if="isNaN((subtotal * vats.vat) / 100 + subtotal)"
                    >0 đ</strong
                  >
                  <strong v-else
                    >{{ (subtotal * vats.vat) / 100 + subtotal }} đ</strong
                  >
                </li> -->
              </ul>
              <br />
        ...
        <div class="col-xl-7 col-lg-7">
          <div class="card mb-4">
            <div
              ...
              "
            >
              <h6 class="m-0 font-weight-bold text-primary">Món đang bán</h6>
            </div>
                        ...
                        >
                          ...
                          <div class="card-body">
                            ...
                            <span
                              ...
                              >Có sẵn {{ product.product_quantity }}
                            </span>
                      ...
                      >
                        ...
                        <div class="card-body">
                          ...
                          <span
                            ...
                            >Có sẵn {{ getproduct.product_quantity }}
                          </span>
                          <span class="badge badge-danger" v-else
                            >Hết hàng
                          </span>
